...
|**🦄박경보**|
| 우선 저는 이번에 처음 진행하는 팀프로젝트여서 모든 과정이 배우는 과정이었습니다. <br>본격적인 작업에 앞서 우선순위를 구분하고 순서대로 작업을 진행하는 것이 가장 중요하다는 것을 알게되었구요. 최대한 자유롭게 소통할 수 있는 분위기를 프로젝트 마칠때가지 끌고 가는 것도 중요하다는 것을 느꼈습니다. <br>리액트의 경우는 재사용 가능한 공통 컴포넌트부터 먼저 만들고 나머지 작업을 진행하는 것이 효율적이라는 것도 알게되었습니다. |
