      ...
      <ModalContext.Provider value={{ isModalOpen, setModalOpen }}>
        <Routes>
          ...
          <Route path="/profile/:id" element={<Outlet />}>
            <Route path="follower" element={<FollowerList type="followers" followType="followerList"/>} />
            <Route path="following" element={<FollowerList type="followings" followType="followingList"/>} />
